...
.topnav-right {
  ...
  <div class="mySlides fade">
    ...
    <center><img src="garage1.jpg" height="550" width="800" align="center" style="width:70%" "height:15%"></center>
  </div>

  <div class="mySlides fade">
    <div class="numbertext">2 / 4</div>
    <center><img src="garage2.jpg" height=550 width=800 style="width:70%" "height:15%"></center>
  </div>

  <div class="mySlides fade">
    <div class="numbertext">3 / 4</div>
    <center><img src="garage3.jpg" height=550 width=800 style="width:70%" "height:15%"></center>
  </div>
  <div class="mySlides fade">
    <div class="numbertext">4 / 4</div>
    <center><img src="garage4.jpg" height=550 width=800 style="width:70%" "height:15%"></center>
  </div> 
